...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; max-width: 600px; margin: 0 auto; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <div style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px; margin: 20px 0;">
            <p style="margin: 0 0 10px 0;"><strong>Nama Akun:</strong> {{ $accounts[0]['name'] }}</p>
            <div style="background-color: #eef2ff; padding: 10px; border-radius: 5px; margin-bottom: 10px; font-weight: bold; color: #333;">
                Email Login: {{ $accounts[0]['email'] }}
            </div>
            <div style="background-color: #fffbeb; padding: 10px; border-radius: 5px; font-weight: bold; color: #b45309; text-align: center; font-size: 18px; letter-spacing: 2px;">
