            ...
            <div class="card">
                <form action="{{ route('roles.store') }}" method="POST" class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="username" name="username" value="{{ old('username') }}" placeholder="Contoh: staff_gudang" required style="width: 100%; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); padding: 10px 15px; border-radius: 6px; color: white; font-size: 14px;">
                    </div>
