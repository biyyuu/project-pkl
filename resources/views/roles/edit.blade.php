...
<head>
    ...
    <title>Edit Role - Inventaris Kemhan Pusdatin</title>
...
<body>
    <div class="app-layout">
        ...
        <main class="main-content">
            <div class="header">
                <div class="header-left">
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 4px;">
                        <h1 style="margin-bottom: 0;">Edit Role: <span style="color: #fbbf24; text-transform: capitalize;">{{ $role->name }}</span></h1>
                    </div>
                </div>
            ...
            <div class="card">
                <form action="{{ route('roles.update', $role->id) }}" method="POST" class="form-container">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" placeholder="Minimal 6 karakter" style="width: 100%; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); padding: 10px 15px; border-radius: 6px; color: white; font-size: 14px;">
                    </div>
